...
function ADNLPModels.get_nln_nnzj(b::SDTSparseADJacobian, nvar, ncon)
  nnz(b.cfJ.sparsity)
end
...
function ADNLPModels.jac_coord!(b::SDTSparseADJacobian, nlp::ADNLPModels.ADModel, x::AbstractVector, vals::AbstractVector)
