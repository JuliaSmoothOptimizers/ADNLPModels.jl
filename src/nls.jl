...
function ADNLSModel(
  ...
  name::String = "Generic",
  adbackend = ADModelBackend(length(x0), x -> sum(F(x) .^ 2), x0),
) where {S}
  T = eltype(S)
  nvar = length(x0)
...
function ADNLSModel(
  ...
  linequ::AbstractVector{<:Integer} = Int[],
  name::String = "Generic",
  adbackend = ADModelBackend(length(x0), length(lcon), x -> sum(F(x) .^ 2), c, x0),
) where {S}
  T = eltype(S)
  nvar = length(x0)
  ncon = length(lcon)
...
function NLPModels.jprod_residual!(
  ...
  jprod!(nls.adbackend.jprod_backend, nls.F, x, v, Jv)
  return Jv
end
...
function NLPModels.jtprod_residual!(
  ...
  jtprod!(nls.adbackend.jtprod_backend, nls.F, x, v, Jtv)
  return Jtv
end
...
function NLPModels.hess_residual(nls::ADNLSModel, x::AbstractVector, v::AbstractVector)
  ...
  ϕ(x) = dot(nls.F(x), v)
  Hx = hessian(nls.adbackend.hessian_backend, ϕ, x)
...
function NLPModels.hprod_residual!(
  ...
  hvprod!(nls.adbackend.hprod_backend, x -> nls.F(x)[i], x, v, Hiv)
  return Hiv
end
...
function NLPModels.jac(nls::ADNLSModel, x::AbstractVector)
  ...
  return jacobian(nls.adbackend.jacobian_backend, nls.c, x)
end
...
function NLPModels.jprod!(nls::ADNLSModel, x::AbstractVector, v::AbstractVector, Jv::AbstractVector)
  ...
  jprod!(nls.adbackend.jprod_backend, nls.c, x, v, Jv)
  return Jv
end
...
function NLPModels.jtprod!(
  ...
  jtprod!(nls.adbackend.jtprod_backend, nls.c, x, v, Jtv)
  return Jtv
end
...
function NLPModels.hprod!(
  ...
  ℓ(x) = obj_weight * sum(nls.F(x) .^ 2) / 2
  hvprod!(nls.adbackend.hprod_backend, ℓ, x, v, Hv)
  return Hv
end
...
function NLPModels.jth_hess_coord!(
  ...
  return hess_coord!(nls.adbackend.hessian_backend, nls, x, x -> nls.c(x)[j], vals)
end
...
function NLPModels.jth_hprod!(
  ...
  hvprod!(nls.adbackend.hprod_backend, x -> nls.c(x)[j], x, v, Hv)
  return Hv
end
...
function NLPModels.ghjvprod!(
  ...
  increment!(nls, :neval_hprod)
  gHv .= directional_second_derivative(nls.adbackend.hessian_backend, nls.c, x, v, g)
  return gHv
end
